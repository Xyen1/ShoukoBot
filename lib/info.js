ekspor . info       = ( id , BotName , corohelp , tampilTanggal , tampilWaktu , instagram , telegram , youtube , kapanbotaktif , grupch1 , grupch2 ) => {
	return `⚜ ${BotName} ⚜
...
INFO BOT! :
🔱 *AUTHOR*: Rvldo
🔱 *GITHUB*: https://github.com/Xyen1/Xyen
🔱 *INSTAGRAM*: ${instagram}
🔱 *YOUTUBE*: ${youtube}
🔱 *TELEGRAM* : ${telegram}
🔱 *WHATSAPP* : 085268921948
